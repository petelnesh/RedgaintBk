...
import com.redgiantbkke.techsavanna.redgiantbk.adapters.StructureSearchAdapter;
import com.redgiantbkke.techsavanna.redgiantbk.helper.ApiClientStructure;
import com.redgiantbkke.techsavanna.redgiantbk.helper.ApiInterfaceStructure;
...
public class DashboardActivity extends AppCompatActivity {
    ApiInterfaceStructure apiInterface;
    ProgressBar progressBar;
    private List<Structure> structureList;
    StructureSearchAdapter adapter;
    ListView listview ;
    SearchView sv;
    ...
    public void fetchStructures(String type, String key){
            apiInterface = ApiClientStructure.getApiStructure().create(ApiInterfaceStructure.class);
        Call<List<Structure>> call = apiInterface.getStructure(type, key);

        call.enqueue(new Callback<List<Structure>>() {
            @Override
            public void onResponse(Call<List<Structure>> call, Response<List<Structure>> response) {
                ...
                adapter = new StructureSearchAdapter(structureList, DashboardActivity.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new android.support.v7.widget.SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                fetchStructures("structure", query);
                return false;
            }

            @Override
            public boolean onQueryTextChange(String newText) {
                fetchStructures("structure", newText);
                return false;
            }
        });
        return true;
